-- Loaded from init.lua before lazy.nvim.

-- Leaders must be set before lazy loads plugins that register keymaps.
vim.g.mapleader = " "
...
opt.fixendofline = true -- Always end files with a newline when writing
opt.foldlevel = 99
opt.foldtext = ""
