...
-- Ported LazyVim default autocmds + the custom smart auto-save.

local function augroup(name)
  return vim.api.nvim_create_augroup("config_" .. name, { clear = true })
end

-- Reload the file when it changed on disk
...
-- ==== Custom: smart auto-save ====
-- Auto-save on BufLeave/WinLeave/FocusLost, but only for real, modifiable files.
